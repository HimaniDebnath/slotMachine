...
//  slot-machine
//
//  Created by Hirak Deb Nath on 16/07/25.
//
...
struct ContentView: View {
    ...
    @State public var symbols = ["eating","happy","cap"]
    ...
    var body: some View {
        ZStack{
            ...
            VStack(alignment: .center, spacing: 40){
                ...
                Text("Attempts Left: \(maxAttempts - counter)")
                    .font(.title3)
                    .fontWeight(.bold)
                    .foregroundStyle(.red)
            ...
            .alert(item : $showingAlert) { alert -> Alert in
                ...
                case .failure:
                    return Alert(title: Text("Opppsssss!"), message: Text("Better luck next time"), dismissButton: .cancel())
                }
            }
        }
    }
